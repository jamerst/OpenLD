...
COPY public."DeviceCodes" ("UserCode", "DeviceCode", "SubjectId", "ClientId", "CreationTime", "Expiration", "Data", "Description", "SessionId") FROM stdin;
\.
...
COPY public."PersistedGrants" ("Key", "Type", "SubjectId", "ClientId", "CreationTime", "Expiration", "Data", "ConsumedTime", "Description", "SessionId") FROM stdin;
\.
...
20200130104011_FixtureChannelCount	5.0.1
20210108200956_NET5Migration	5.0.1
\.
